"""Evaluate an MSHNet checkpoint on challenge-format validation data."""
from __future__ import annotations

import argparse
import json

from jinsight_track1.mshnet_adapter import evaluate_mshnet
...
def main() -> None:
    ...
    parser.add_argument(
        "--temporal-radius",
        type=int,
        help="override checkpoint temporal radius",
    )
